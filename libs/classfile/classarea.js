    ...
    var getAttribues = function(attribute_name_index, bytes) {
        ...
        switch(item.tag) {
            ...
            case TAGS.CONSTANT_String:
                ...
                res.constantvalue_index = reader.read16();
                return res;        
            ...
            case TAGS.CONSTANT_Utf8:
                ...
                switch(item.bytes) {
                    ...
                    case "Code":
                        ...
                        res.max_stack = reader.read16();
                        res.max_locals = reader.read16();
                        var code_length = reader.read32();
                        res.code = reader.readBytes(code_length);
                        ...
                        for(var i=0; i<attributes_count; i++) {
                            ...
                            var attribute_length = reader.read16();
                    ...
                    case "SourceFile":
                        ...
                        res.sourcefile_index = reader.read16();
                        return res;
                    ...
                    case "Exceptions":
                        ...
                        for(var i=0; i<number_of_exceptions; i++) {
                            res.exception_index_table.push(reader.read16());
                        }
                        return res;
