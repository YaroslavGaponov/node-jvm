...
describe('Object', function () {
    before(function(done){
        this.timeout(10000);
        child_process.exec("javac basic/Object.java", {cwd : __dirname},function(err){
            if (err) throw err;
            jvm.loadClassFile(__dirname + "/basic/Object.class");
            done();
        });
    });
    ...
    describe("equals", function () {
        it("should return true for same instance", function () {
            var o = CLASSES.createNewObject("basic/Object");
            expect(o.equals(o)).to.be.true;
        });

        it("should return false for different instances", function () {
            var o1 = CLASSES.createNewObject("basic/Object");
            var o2 = CLASSES.createNewObject("basic/Object");
    ...
    describe("getClass", function () {
        it("return correct class object", function () {
            var o = CLASSES.createNewObject("basic/Object");
            expect(o.getClassName()).to.be.equal("basic/Object");
        });
    });
    ...
    describe("toString", function () {
        it("return correct class object", function () {
            var o = CLASSES.createNewObject("basic/Object");
            expect(o.toString()).to.be.equal("basic/Object" + '@' + o.hashCode().toString(16));
        });
    });
